...
/**
 * Write a description of class CategorieA here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CategorieA implements Categorie
{
    // instance variables - replace the example below with your own
    private int listeCategorie;
    private int listeInfoCategorie;
    private int listeArticle;
    /**
     * Constructor for objects of class CategorieA
     */
    public CategorieA()
    {
